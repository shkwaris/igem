      ...
      <div class="row">
        ...
        <div class="col-lg-9 main-content" id="main-content">
          <section id="section1">
            ...
            <p>During the call with the patient’s association, Pnoi Agapis, we had the chance to communicate with a radiologist, <span>George Pissakas</span>, who not only informed us about lung cancer statistics but also helped us gain an accurate understanding touching the pros and cons of the existing diagnostics techniques, especially chest x-ray.</p>
          ...
          <section id="section3">
            ...
            <p>That way, we came upon <span>Galatea Kallergi</span>, an Assistant Professor of Biochemistry at the University of Patras and a researcher at the European Liquid Biopsy Society (ELBS).</p>
          ...
          <section id="section4">
            ...
            <section id="section4-1">
              ...
              <p>We​​ consulted <span>Dr. Klapa Maria</span>, founder, and head of FORTH/ICE-HT Metabolic Engineering and Systems Biology Laboratory, for her expertise in mathematical modeling of biological systems and networks and quantitative systems biology. </p>
            ...
            <section id="section4-2">
              ...
              <p>He also helped us create our Software by integrating loops in the NUPACK software to obtain the thermodynamic properties and all the possible structures for the various components of our system. That way, we can model our whole reaction with the simple input of a mature circRNA sequence. Please refer to the <a class="link-ref" target="_blank" href="model">Model</a> and <a class="link-ref" target="_blank" href="software">Software</a> pages for the thermodynamic results and a detailed description of the ldn_generator.py, respectively.</p> 
              ...
              <p>For that cause, we got in touch with <span>Kavakiotis Ioannis</span>: Head of the Biomedical Data Science and Bioinformatics Unit. It was very insightful since his knowledge in fields such as nucleic acid interaction, structure modeling, and Molecular Dynamics gave us a good view of what to expect. </p>
              ...
              <p>Finally, he instructed us first to dock the circular DNA template to the protein using the HDOCK web server or the HADDOCK 2.4 webserver. We integrated the use of HDOCK into our modeling work, generating complexes with good docking scores. Please refer to the <a class="link-ref" target="_blank" href="model">Model</a> page to view our results.</p>
            </section>
          </section>
          <section id="section5">
