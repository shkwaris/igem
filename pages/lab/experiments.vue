<template>
    <div>
        <Header title="Experiments">Describe the research, experiments, and protocols you used in your iGEM project.
        </Header>
        <div class="container">
            <div class="row mt-4">
                <div class="col-lg-8">
                    ...
                    <hr>
                    <p>Describe the research, experiments, and protocols you used in your iGEM project. These should be
                        detailed enough for another team to repeat your experiments.</p>
                    <p>If you made Parts this year, please remember to put all information, characterization, and
                        measurement data on the Part's Main Page on the <a
                            href="http://parts.igem.org/Main_Page">Registry</a>.</p>
                </div>
                <div class="col-lg-4">
                    <h2>Inspirations</h2>
                    <hr>
