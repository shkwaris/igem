<template>
    <div>
        <Header title="Contribution">Make a useful contribution for future iGEM teams. Use this page to document that
            contribution.</Header>
        <div class="container">
            <div class="row mt-4">
                <div class="col">
                    <div class="bd-callout bd-callout-info">
                        ...
                        <p>If you are making a contribution by adding information to an existing Part or creating a new
                            ...
                            this criteria. You can use this page to link to that part and include additional information
