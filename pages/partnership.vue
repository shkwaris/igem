      ...
      <div class="row centered">
        <div class="col">
          ...
          <div class="timeline-menu">
            <a @click="scrollToMonth('#march'); clicked='march'" :class="clicked == 'march' ? 'active' : ''" name="march">March</a> -
            <a @click="scrollToMonth('#april'); clicked='april'" :class="clicked == 'april' ? 'active' : ''" name="april">April</a> -
            <a @click="scrollToMonth('#may'); clicked='may'" :class="clicked == 'may' ? 'active' : ''" name="may">May</a> -
            <a @click="scrollToMonth('#june'); clicked='june'" :class="clicked == 'june' ? 'active' : ''" name="june">June</a> -
            <a @click="scrollToMonth('#july'); clicked='july'" :class="clicked == 'july' ? 'active' : ''" name="july">July</a> -
            <a @click="scrollToMonth('#august'); clicked='august'" :class="clicked == 'august' ? 'active' : ''" name="august">August</a> -
            <a @click="scrollToMonth('#september'); clicked='september'" :class="clicked == 'september' ? 'active' : ''" name="september">September</a> -
          ...
          <ul class="timeline timeline-centered" style="overflow-x: hidden">
            <section id="march" class="nopad">
              ...
              <li class="timeline-item left" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" data-aos-offset="100">
                ...
                <div class="timeline-content">
                  ...
                  <p>On the 11th of March, Maria Kosmidou, Leader of Fundraising of the MetaThess team, trained our team about the steps a team must follow to find sponsors. So, together we made a sponsorship booklet, which includes information about iGEM Competition, our team members, our project description, our budget analysis, and specific sponsorship packages for our potential sponsors. The selling points were about how we can advertise our potential sponsors, for example, during our actions or on social media. We also prepared a list containing approximately 207 Pharmaceutical and Medical companies with their contact details and prepared the template mail we will send to the sponsors attaching the Booklet. The next day the communications started, and soon we ended up having as a joint grand sponsor the Research Genetic Cancer Center (RGCC Group), established in 2004 by Dr. Papasotiriou Ioannis, Oncologist.</p>
                  <div class="timeline-images gallery">
            ...
            <section id="june" class="nopad">
              ...
              <li class="timeline-item right" data-aos="fade-left" data-aos-duration="1000" data-aos-once="true" data-aos-offset="100">
                ...
                <div class="timeline-marker"></div>
                <div class="timeline-content">
                  <h3 class="timeline-title">Wet Lab - Troubleshooting</h3>
                  <p>During this year, our team’s wet lab members participated in several “wet lab meetings” with iGEM MetaThess team. These meetings were quietly beneficial for the experimental design and implementation of our projects since our cooperation led to the development of new ideas and the faster completion of “open” experimental issues that occupied both teams. Furthermore, during these meetings, extensive troubleshooting conversations were conducted, and different experimental protocols and tips and tricks were exchanged to accelerate the experimental procedures and achieve the desired results.</p>
                </div>
              </li>
            </section>
            ...
            <section id="july" class="nopad">
              ...
              <li class="timeline-item left" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" data-aos-offset="100">
                ...
                <div class="timeline-marker"></div>
                <div class="timeline-content">
                  <h3 class="timeline-title">Preparing our Business plans</h3>
              ...
              <li class="timeline-item right" data-aos="fade-left" data-aos-duration="1000" data-aos-once="true" data-aos-offset="100">
                ...
                <div class="timeline-marker"></div>
                <div class="timeline-content">
                  <h3 class="timeline-title">The second meeting of Dry Lab teams</h3>
              ...
              <li class="timeline-item left" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" data-aos-offset="100">
                ...
                <div class="timeline-content">
                  ...
                  <p>Every year July 30th is designated as World Friendship Day. Our beautiful collaboration with iGEM MetaThess team led to new friendships. So we took advantage of this World Day and designed a graphic design that we published on social media. We officially announced for the first time that we are partners and working together for the iGEM Competition.</p>
                  <div class="timeline-images gallery">
            ...
            <section id="october" class="nopad">
              ...
              <li class="timeline-item right" data-aos="fade-left" data-aos-duration="1000" data-aos-once="true" data-aos-offset="100">
                ...
                <div class="timeline-content">
                  ...
                  <p>On the 2nd of October, in collaboration with the CPRG Group and iGEMMetaThess , we organized a webinar about lung cancer. In the webinar, some greetings from professors and speeches about the epidemiology of lung cancer and its types started. Then Mr. Velissariou Ilias and Mr. Βochalis Eleftherios presented the project of Patras Medicine 2022 group and the diagnostic methods used today. Finally, Mrs. Gouliou Ioanna and Mrs. Kosmidou Maria gave the project of iGEM MetaThess team and the therapeutic techniques used to treat lung cancer. The webinar was attended by approximately 300 people, including doctors, researchers, and journalists. At the end of the webinar, the audience's questions were resolved, and it was discussed how important prevention and early diagnosis are in diseases such as cancer. The public understood that surgery could save the patient if the cancerous tumor is detected early and has not metastasized. We received a lot of positive feedback from the public, which confirmed that there is a need for in vitro diagnostic tools that can easily, quickly, and cheaply diagnoses cancer. We are proud because many believed in our ideas and expressed interest in being among the first to do these diagnostic blood tests. Finally, they wished us all the best.</p>
                  <div class="timeline-images gallery">
              ...
              <li class="timeline-item right" data-aos="fade-left" data-aos-duration="1000" data-aos-once="true" data-aos-offset="100">
                ...
                <div class="timeline-marker"></div>
                <div class="timeline-content">
                  <h3 class="timeline-title">Our last meeting</h3>
                  <p>On October 7th, the last virtual meeting between those responsible for the partnership occurred. At the specific meeting, iGEM MetaThess team showed the other the final form of their wiki and vice versa. Again, we emphasized the design of the partnership and shaped its final form for both our wiki pages.
                    <br><br>
...
export default {
    ...
    methods: {
      ...
      changeActive: function (id, isActive) {
        const a = document.querySelector(`.timeline-menu a[name="${id}"]`)
        // .classList
        console.log(a);
        if (isActive) {
          a.className = "active";
