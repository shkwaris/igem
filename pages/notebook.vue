<template>
    <div>
        <Header title="Notebook">Document the dates you worked on your project. This should be a detailed account of the
            work done each day for your project.</Header>
        <div class="container">
            <div class="row mt-4">
                <div class="col-lg-8">
                ...
                <div class="col-lg-4">
                    ...
                    <ul>
                        ...
                        <li><a href="https://2020.igem.org/Team:IISER-Pune-India/Notebook">2020 IISER Pune India</a>
                        </li>
