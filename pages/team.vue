                            ...
                            <figure class="effect">
                                ...
                                <figcaption>
                                    ...
                                    <template v-for="category in member.categories">
                                        ...
                                        <span class="role entrepreneurship" v-if="category === 'Finance Entrepreneurship'">{{category}}</span>
...
export default {
    ...
    mounted() {
        let url = "https://static.igem.wiki/teams/4118/wiki/website-assets/members/members.json"
        fetch(url)
          .then(res => res.json())
