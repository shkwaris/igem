<template>
    <div>
      ...
      <div class="bg" style="background: url('https://static.igem.wiki/teams/4118/wiki/website-assets/covers/general.jpg') center center no-repeat; background-size: cover;">
      ...
      <section class="container sponsors-content">
        <div class="row">
          <div class="col-xs-12">
            <img class="rgcc" src="https://static.igem.wiki/teams/4118/wiki/website-assets/sponsors/logo-rgcc-white.png" alt="RGCC" />
          ...
          <div class="col-xs-12">
            <img class="naco" src="https://static.igem.wiki/teams/4118/wiki/website-assets/sponsors/naco-logo.png" alt="Naco" />
          ...
          <div class="col-xs-12">
            <img class="patrasuniversity" src="https://static.igem.wiki/teams/4118/wiki/website-assets/sponsors/patras-university-logo.png" alt="Patras University" />
          ...
          <div class="col-xs-12">
            <img class="idt" src="https://static.igem.wiki/teams/4118/wiki/website-assets/sponsors/idt-logo.png" alt="IDT" />
            <p>Integrated DNA Technologies, Inc. (IDT) is in the business of moving science forward. We are scientists working for scientists. Our innovative tools and solutions for genomics applications are breaking down barriers and inspiring you to dream big and achieve your next breakthroughs.</p>
            <a href="https://eu.idtdna.com/pages" class="sponsors-link" target="_blank">https://eu.idtdna.com/pages</a>
          </div>

          <div class="col-xs-12">
            <img class="neb" src="https://static.igem.wiki/teams/4118/wiki/website-assets/sponsors/neb-logo.png" alt="NEB" />
          ...
          <div class="col-xs-12">
            <img class="snapgene" src="https://static.igem.wiki/teams/4118/wiki/website-assets/sponsors/snapgene-logo.png" alt="SnapGene" />
